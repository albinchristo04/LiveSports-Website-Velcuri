        ...
        <div className="container" style={{ padding: '2rem', maxWidth: '800px' }}>
            ...
            <div className="glass-panel" style={{ padding: '2rem', marginTop: '2rem' }}>
                ...
                <ul style={{ listStyleType: 'disc', paddingLeft: '1.5rem', marginTop: '0.5rem' }}>
                    ...
                    <li><strong>Cookies:</strong> We use cookies to enhance your experience and analyze traffic (via Google Analytics).</li>
                </ul>
                ...
                <p>We use third-party services such as Google Analytics. These third parties may access your data to perform tasks on our behalf and are obligated not to disclose or use it for any other purpose.</p>
